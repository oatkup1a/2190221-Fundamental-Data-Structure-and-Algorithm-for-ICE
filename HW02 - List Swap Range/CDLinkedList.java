public class CDLinkedList {
	...
	public void swapRange(Iterator s1, Iterator f1, Iterator s2, Iterator f2) {
		...
		//If any iterators are null, return nothing
		if (s1 == null || !(s1 instanceof DListIterator) ||
			 f1 == null || !(f1 instanceof DListIterator) || 
			 s2 == null || !(s2 instanceof DListIterator) || 
			 f2 == null || !(f2 instanceof DListIterator)) {
			return;
		}
		
		DListIterator l1start = (DListIterator)s1;
		DListIterator l1end = (DListIterator)f1;
		DListIterator l2start = (DListIterator)s2;
		DListIterator l2end = (DListIterator)f2;
		DListNode l1before = l1start.currentNode.previousNode; //List before l1
		DListNode l1after = l1end.currentNode.nextNode; //List After l1
		DListNode l2before = l2start.currentNode.previousNode; //List Before l2
		DListNode l2after = l2end.currentNode.nextNode; //List After l2
		
		//Before each list
		l1before.nextNode = l2start.currentNode;
		l2before.nextNode = l1start.currentNode;
		
		DListNode tempPoint1 = l1start.currentNode.previousNode; //Save point to swap later
		l1start.currentNode.previousNode = l2start.currentNode.previousNode;
		l2start.currentNode.previousNode = tempPoint1;
		
		//After each list
		l1after.previousNode = l2end.currentNode;
		l2after.previousNode = l1end.currentNode;
		
		DListNode tempPoint2 = l1end.currentNode.nextNode; //Save point to swap later
		l1end.currentNode.nextNode = l2end.currentNode.nextNode;
		l2end.currentNode.nextNode = tempPoint2;
